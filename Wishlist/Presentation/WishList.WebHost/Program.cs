...
using WishList.WebHost.Helpers;
...
{
    throw new InvalidOperationException("Connection string for WishListDbContext is not configured.");
}

builder.Services.AddNpgsql<ApplicationDbContext>(connectionString, options =>
{
    options.MigrationsAssembly("WishList.Infrastructure.EntityFramework");
